...
| [Accuracy Operations](accuracy-operations.md) | Backfill + settle scripts/commands for AI pick and Top Picks. |
...
| [Insight Generation Engine](insight-generation-engine.md) | Matchup score, insight categories, Top Picks pipeline, Top Insights by matchup UI. |
...
- **Top Picks / Insights:** [Insight Generation Engine](insight-generation-engine.md)
- **Accuracy backfill / settle:** [Accuracy Operations](accuracy-operations.md)
