...
function App() {
  return (
    <div style={{ padding: 16 }}>
      <div style="padding:8px;background:#fff7e6;border:1px solid #ffe58f;margin-bottom:12px;fontSize:13px">Disclaimer: Informational purposes only. Not financial advice.</div>
      <h1>NBA Stat Spot</h1>
